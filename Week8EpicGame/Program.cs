...
//string[] villains = {"Voldemort", "Darth Vader", "Joker", "Dracula", "Sauron" };
...
string folderPath = @"C:\Users\Igor\Desktop\Data1\";
string heroFile = "hero.txt";
...
//string[] heroes = { "Harry Potter", "Luke Skywalker", "Lara Croft", "Scooby-Doo" };
//string[] villains = { "Voldemort", "Darth Vader", "Joker", "Dracula", "Sauron" };
string[] weapon = { "Lego Brick", "Wooden Sword", "Magic Wand", "Plastic Fork", "Banana" }; 
...
static int Hit(string characterName, int characterHP) 
{
    ...
    {
        Console.WriteLine($"{characterName} has made a critical hit");
    }
    else
    {
